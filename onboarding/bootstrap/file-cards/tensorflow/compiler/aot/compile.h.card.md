# File Card — tensorflow/compiler/aot/compile.h
...
AOT compilation: tfcompile tool library. Worker must explain: CompileGraph() → CompileResult, feed/fetch config, CpuAotCompilationResult, architecture-specific output. Trap: requires fully static shapes; CPU-only. Impact: enables inference without TF runtime.
